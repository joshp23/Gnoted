	...
	<body>
    	...
    	input { border: 1px solid black; }
  		...
  		<div style="width:500px; margin-left:auto; margin-right:auto; text-align:center">
  			<form method="post">
    			<h2>Welcome to Gnoted!</h2>
    			<img style="display:block;margin:0 auto;" src="assets/256x256_gnoted.png">
    			<h5>Please log in to continue</h5>
    			<font color="red"><?php echo $error_msg; ?></font><br />
				<?php if (USE_USERNAME) echo 'Login:<br /><input type="input" name="access_login" /><br />Password:<br />'; ?>
   			 	<input type="password" name="access_password" /><p></p><input type="submit" name="Submit" value="Submit" />
  			</form>
  			<a style="font-size:9px; color: #B0B0B0; font-family: Verdana, Arial;" href="http://unfettered.net" title="Unfettered">Unfettered</a>
  		</div>
	</body>
</html>
